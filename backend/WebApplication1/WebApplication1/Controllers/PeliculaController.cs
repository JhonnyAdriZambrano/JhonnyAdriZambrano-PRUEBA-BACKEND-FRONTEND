...
namespace API_REST_PRUEBA.Controllers
{
    ...
    public class PeliculaController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllPeliculas()
        {
            ...
            {
                return StatusCode(StatusCodes.Status500InternalServerError, "Error interno al obtener películas");
            }
        ...
        public async Task<IActionResult> BorrarPelicula(int id)
        {
            ...
            {
                return StatusCode(StatusCodes.Status500InternalServerError, "Error interno al borrar la película.");
            }
        }
    }
}